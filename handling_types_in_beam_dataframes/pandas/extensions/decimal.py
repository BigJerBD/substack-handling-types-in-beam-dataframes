...
from apache_beam.typehints.pandas_type_compatibility import BEAM_TO_PANDAS, PANDAS_TO_BEAM
...
# Register Into Pandas
register_extension_dtype(DecimalDtype)

# Register translations from beam to pandas and pandas to beam
BEAM_TO_PANDAS[decimal.Decimal] = DecimalDtype()
PANDAS_TO_BEAM[DecimalDtype()] = decimal.Decimal
